...
void Render() {
    ...
    ImGui::Begin("ClickAnalyzer", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoScrollbar);

    ImGui::SetCursorPos(ImVec2(0, 0));
    if (ImGui::Button("CLICK ME", { 320.f,200.f })) {
    ...
    if (ImGui::Button("Calculate", { 320.f, 40.f })) {
        int1 = 2;
        ...
        averMS = "AVERAGE MS: " + std::to_string(average(msArr, totalClicks));
    ...
    std::string m = "MS: " + std::to_string(ms);
